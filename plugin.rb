...
after_initialize do
  %w[
    ...
    ../app/models/discourse_layouts/component.rb
    ../app/serializers/discourse_layouts/component_serializer.rb
    ../app/controllers/discourse_layouts/components_controller.rb
